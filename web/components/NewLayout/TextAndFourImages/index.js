...
import RedirectButton from '../../OldLayout/RedirectButton'
...
function TextAndFourImages(props) {
  const {heading, description, backgroundImage, button, sideImage1, sideImage2, sideImage3, sideImage4, currentLanguage } = props
...
TextAndFourImages.propTypes = {
  ...
  sideImage4: PropTypes.object,
  currentLanguage: PropTypes.object,
}

export default TextAndFourImages