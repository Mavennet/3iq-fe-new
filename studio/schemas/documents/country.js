...
export default {
  ...
  fields: [
    ...
    },
    {
      ...
      title: 'Address (*)',
      description: "Address that will be displayed in the footer",
      validation: Rule => Rule.error('Information required.').required(),
    },
    {
      ...
      type: 'localeString',
      title: 'Phone Number (*)',
      description: "Phone Number that will be displayed in the footer",
      validation: Rule => Rule.error('Information required.').required(),
    },
    {
      name: 'footerEmail',
      type: 'localeString',
      title: 'Email (*)',
      description: "Email that will be displayed in the footer",
      validation: Rule => Rule.error('Information required.').required(),
    },
    {
      name: 'footerSchedule',
