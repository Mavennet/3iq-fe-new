...
export default {
  ...
  fields: [
    ...
    },
    {
      ...
      title: "HTML Table",
      description:
        "Create an optional hardcoded HTML table through the EmbedHTML tag"
    },
    {
      name: "keyFactsTableOne",
      title: "Key Facts Table Part One",
      type: "array",
      of: [
        {
          type: "reference",
          to: [{ type: "keyFact" }],
          title: "Key Fact Items"
        }
      ]
    },
    {
      name: "keyFactsTableTwo",
      title: "Key Facts Table Part Two",
      type: "array",
      of: [
        {
          type: "reference",
    ...
    },
    {
      ...
      title: "API Endpoint",
      description:
        "Insert the URL for the API endpoint that will retrieve the data to populate the table automatically",
      validation: Rule =>
        Rule.uri({
          allowRelative: false,
          scheme: ["https", "http"]
